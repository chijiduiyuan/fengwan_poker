...
// 微信支付相关参数
define('WE_CHAT_PAY_APP_ID', '');
define('WE_CHAT_PAY_MCH_ID', '');
define('WE_CHAT_PAY_KEY', '');
define('WE_CHAT_PAY_NOTIFY_URL', '');
define('WE_CHAT_PAY_CERT_CLIENT', '');
define('WE_CHAT_PAY_CERT_KEY', '');
